...
function onSelectEnableComponent (elementName, componentName, type) {
    component = null;
    component = getSelectElement(elementName);
    if(component.value == "internal") {
        disableComponent(componentName, type);
    }
    else {
        enableComponent(componentName, type);
    }
}
